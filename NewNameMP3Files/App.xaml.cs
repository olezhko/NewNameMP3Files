...
namespace NewNameMP3Files
{
    ...
    public partial class App : Application
    {
        ...
        {
            Language = NewNameMP3Files.Properties.Settings.Default.DefaultLanguage;
        }

        private static void App_LanguageChanged(Object sender, EventArgs e)
        {
            NewNameMP3Files.Properties.Settings.Default.DefaultLanguage = Language;
            NewNameMP3Files.Properties.Settings.Default.Save();
        }
